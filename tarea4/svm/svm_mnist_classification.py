...
param_gamma = 0.05
max_iterations = 50
classifier = svm.SVC(C=param_C,gamma=param_gamma,verbose=True, max_iter=max_iterations)
...
joblib.dump(classifier, './models/model_iter:'+str(max_iterations)+'_'+str(time.time())+'.sav')
########################################################
